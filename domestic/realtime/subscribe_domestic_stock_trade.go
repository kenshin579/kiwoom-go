...
func decodeDomesticStockTrade(d wstransport.Delivery) stream.Event[DomesticStockTrade] {
	...
	ev := stream.Event[DomesticStockTrade]{Symbol: d.Item, Name: d.Name, StexTp: d.StexTp, Time: d.Time, Err: d.Err}
	if d.Err != nil {
		return ev
	}
