...
// 버린 표기는 그 줄 주석에 남겼다.
//
// 반대로 **한글명이 같은데 FID 가 다른** 것이 일곱 쌍 있다(예상체결가 23·291,
// 매수비율 129·1032, 거래소구분 337·2134·9081, 대출일 916·923, 신용구분 917·922,
// Extra Item 924·951·1279, 시간 20·21). 이름을 하나로 접을 수 없어 — 23 과 291 은 같은
// 실시간 타입(0D)에 **함께** 들어간다 — 어느 쪽이 무엇인지 그 줄 주석에 적고 이름을 갈랐다.
//
...
var Fids = []Fid{
	...
	{"22", "TradeDate", "체결일자"},
	{"23", "ExpectedPrice", "예상체결가"}, // 호가잔량(0D)의 예상체결가. FID 291 과 한글명이 같아 이름을 갈랐다
	...
	{"81", "AskPricePrevDiff1", "매도1호가직전대비"},    // 표기 차이: 매도호가직전대비1
	{"82", "AskPricePrevDiff2", "매도2호가직전대비"},    // 표기 차이: 매도호가직전대비2
	{"83", "AskPricePrevDiff3", "매도3호가직전대비"},    // 표기 차이: 매도호가직전대비3
	{"84", "AskPricePrevDiff4", "매도4호가직전대비"},    // 표기 차이: 매도호가직전대비4
	{"85", "AskPricePrevDiff5", "매도5호가직전대비"},    // 표기 차이: 매도호가직전대비5
	{"86", "AskPricePrevDiff6", "매도6호가직전대비"},    // 표기 차이: 매도호가직전대비6
	{"87", "AskPricePrevDiff7", "매도7호가직전대비"},    // 표기 차이: 매도호가직전대비7
	{"88", "AskPricePrevDiff8", "매도8호가직전대비"},    // 표기 차이: 매도호가직전대비8
	{"89", "AskPricePrevDiff9", "매도9호가직전대비"},    // 표기 차이: 매도호가직전대비9
	{"90", "AskPricePrevDiff10", "매도10호가직전대비"},  // 표기 차이: 매도호가직전대비10
	{"91", "BidPricePrevDiff1", "매수1호가직전대비"},    // 표기 차이: 매수호가직전대비1
	{"92", "BidPricePrevDiff2", "매수2호가직전대비"},    // 표기 차이: 매수호가직전대비2
	{"93", "BidPricePrevDiff3", "매수3호가직전대비"},    // 표기 차이: 매수호가직전대비3
	{"94", "BidPricePrevDiff4", "매수4호가직전대비"},    // 표기 차이: 매수호가직전대비4
	{"95", "BidPricePrevDiff5", "매수5호가직전대비"},    // 표기 차이: 매수호가직전대비5
	{"96", "BidPricePrevDiff6", "매수6호가직전대비"},    // 표기 차이: 매수호가직전대비6
	{"97", "BidPricePrevDiff7", "매수7호가직전대비"},    // 표기 차이: 매수호가직전대비7
	{"98", "BidPricePrevDiff8", "매수8호가직전대비"},    // 표기 차이: 매수호가직전대비8
	{"99", "BidPricePrevDiff9", "매수9호가직전대비"},    // 표기 차이: 매수호가직전대비9
	{"100", "BidPricePrevDiff10", "매수10호가직전대비"}, // 표기 차이: 매수호가직전대비10
	...
	{"50725", "ExchangeRealizedProfitPurchaseAmount", "환전실현손익매입금액 사용"},
	{"50810", "OrderStopPrice", "주문STOP가격"},
	{"50841", "ReservationType", "예약구분"},
	{"50844", "ExchangeRealizedProfitAmount", "환전실현손익금액 사용"},
